...
class RealexTest < Test::Unit::TestCase
  ...
  class ActiveMerchant::Billing::RealexGateway
    ...
    public :build_purchase_or_authorization_request, :build_refund_request, :build_void_request, :build_capture_request, :build_verify_request, :build_credit_request, :build_add_payer_request,
      :build_add_payment_method_request, :build_delete_payment_method_request, :build_receipt_in_request,
